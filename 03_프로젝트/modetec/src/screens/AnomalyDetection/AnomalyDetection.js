  ...
  return (
    <div className='AnomaylDetection'>
      <div className='Container'>
        ...
        <div className='Frame'>
          <iframe src="http://3.36.169.149:5601/app/dashboards#/view/92eaae60-2b6c-11ee-a0f2-110032b8cf20?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A60000)%2Ctime%3A(from%3Anow-24h%2Fh%2Cto%3Anow))&hide-filter-bar=true" height="100%" width="100%"></iframe>
        </div>
        <TableList>
          <table stickyheader>
            <TableHead>
